...
<head>
    <meta charset="utf-8">
    <title>Club Enrollment Print</title>
   ...
   <?php } ?>
                            ...
                            <td>
                               ...
                               <b> Student Reg Date:</b> <?php echo htmlentities($row['studentregdate']);?><br>
                                <b> Student Club Enroll Date:</b> <?php echo htmlentities($row['edate']);?><br>
                            </td>
                        </tr>
                    </table>
                </td>
