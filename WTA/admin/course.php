...
{
  $_SESSION['msg']="Error : CLUB not created";
}
}
if(isset($_GET['del']))
      {
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line" style="text-align:center;">Club  </h1>
                    </div>
                </div>
                <div class="row" >
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
   ...
   <div class="form-group">
    <label for="coursecode">Club Code  </label>
    <input type="text" class="form-control" id="coursecode" name="coursecode"  required />
  </div>

 <div class="form-group">
    <label for="coursename">Club Name  </label>
    <input type="text" class="form-control" id="coursename" name="coursename"  required />
  </div>

<div class="form-group">
    <label for="courseunit">Club unit  </label>
    <input type="text" class="form-control" id="courseunit" name="courseunit"  required />
  </div> 
