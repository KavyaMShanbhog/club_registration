...
$course=$_POST['course'];
$sem=$_POST['sem'];
$ret=mysqli_query($con,"insert into courseenrolls(studentRegno,pincode,session,department,course,semester) values('$studentregno','$pincode','$session','$dept','$course','$sem')");
if($ret)
{
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line" style="text-align:center;">Club Enroll </h1>
                    </div>
                </div>
                <div class="row" >
